...
\end{equation}
using the Crank-Nicolson method \todo{Cite}, where the ${}^\circ$ operator is applied column-wise. We can then express the heat equation as the convex optimization problem
\begin{equation}
  \begin{array}{lll}
